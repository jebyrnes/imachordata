...
Back in February (remember February), while teaching [data science](http://biol355.github.io), I was trying to think of ways to spice up the class with more relevant data. We were in the midst of data tidying, when I saw a tweet from [Rami Krispin](https://twitter.com/Rami_Krispin/) (whose account as of 2022-11-27 is suspended?)
